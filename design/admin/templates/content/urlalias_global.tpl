...
<div class="block">
    ...
    <p>{'With <em>Alias should redirect to its destination</em> checked Exponential will redirect to the destination using a HTTP 301 response. Un-check it and the URL will stay the same &#8212; no redirection will be performed.'|i18n( 'design/admin/content/urlalias' )}
    </p>
</div>
