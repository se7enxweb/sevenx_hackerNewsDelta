...
<h3>{'What is Exponential?'|i18n( 'design/admin/ezinfo/about' )}</h3>
...
{else}
    <p>{'Could not load LICENSE file! You should have a LICENSE file in your Exponential root directory.'|i18n( 'design/admin/ezinfo/about' )}</p>
{/if}
