...
{def $attribute_hide_list=array( 'metadata' )}
    ...
    <div class="class-poll">
        ...
        {section loop=$object.contentobject_attributes}
        	...
        	{let  attribute=$:item
                  ...
                  total_count=fetch( 'contextual', 'collected_digg_info_count', hash( 'object_attribute_id', $contentobject_attribute_id ) )
        ...
        {"%count total votes"|i18n( 'design/base' ,,
            ...
            <div class="content-results">
                <div class="attribute-link">
                    <p><a href={$node.url_alias|ezurl}>{"Back to digg"|i18n("design/base")}</a></p>
                </div>
            </div>
