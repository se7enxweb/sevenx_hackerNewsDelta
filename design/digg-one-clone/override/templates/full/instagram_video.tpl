...
<div class="news-full" id="main0" style="">
     ...
     {section show=$node.data_map.link.content.is_empty|not}<p>{attribute_view_gui attribute=$node.data_map.link}</p>{/section}
     ...
     <div class="news-details">
       ...
       <span class="tool">
       category: <a href={$node.parent.url_alias|ezurl}>{$node.parent.name|wash}</a> | <a href={concat("/spy/collectionlist/", $node.object.id)|ezurl} class="">{"story digg history"}</a>
       </span>
     </div>
