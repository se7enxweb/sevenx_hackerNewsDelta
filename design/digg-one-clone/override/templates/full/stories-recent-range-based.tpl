...
{set $parent_node_id=687}
{* all story node id *}
{elseif $node.node_id|eq( 283 )}
{set $parent_node_id=286}
{* top stories node id *}
{elseif $node.node_id|eq( 379 )}
{set $parent_node_id=286}
{* story node id *}
{elseif $node.node_id|eq( 285 )}
{* category node id *}
{set $parent_node_id=286}
{/if}
...
{def $startDateTimestamp=currentdate()|sub(604800)|sub(604800)|sub(604800)|sub(604800)
...
{*$childrenNodes|attribute(show,1) *}
...
{* <div class="attribute-header">
	...
	<div class="content-view-children float-break">
	  ...
	  *}
	  ...
	  {include name=navigator
              ...
              item_count=$children_count|sum(-3)
    ...
    <div class="notice-more">
     Looking for more? Try submitting a new story to digg's <a href="{if $node.depth|lt(2)}https://digg.one/submit{else}https://digg.one/c#select-a-category-first{/if}">categories</a> section which will apear in the <a href="/all/(dir)/1">upcoming</a> section for voting to begin!
    </div>
