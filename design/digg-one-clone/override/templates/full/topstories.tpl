...
{* <div class="attribute-header">
    ...
    <div class="notice-more">
     Looking for more? Try submitting a new story to DiggClone's <a
     href="{if $node.depth|lt(2)}https://clone.digg.one/submit{else}https://clone.digg.one/c#select-a-category-first{/if}">categories</a> section
