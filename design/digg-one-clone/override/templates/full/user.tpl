...
<div class="content-view-full">
    <div class="class-folder">
	 ...
	 {* <p>Welcome to Digg [Sigma] social networking news website where the news is user submitted and moderated. Start voting for your favorite stories on <a href="/all" target="_self">/all</a>/<a href="/all/upcoming" target="_self">upcoming</a></p><p><b>Instructions</b>: <a href="/user/register" target="_self">Signup</a> or <a href="/user/login" target="_self">login</a> and then <b><i>navigate to a sub </i></b><u><a href="/c" target="_self">category</a></u> to be able to submit your own unique news story for others to digg (vote) with their diggs!</p> *}
	 <h1>Profile</h1>
	 </div>
        ...
        <div class="attribute-header">
            ...
            <h3>{$node.data_map.first_name.content|wash} {$node.data_map.last_name.content|wash}</h3>
        </div>
        <p class="date">
...
{set $parent_node_id=687}
{elseif $node.parent.node_id|eq( 12 )}
{set $parent_node_id=$node.node_id}
{/if *}
...
*}
    ...
    <h3><a href={concat( $node.url_alias, '/submitted' )|ezurl()}>User Submitted Stories</a></h3>
    </div>
