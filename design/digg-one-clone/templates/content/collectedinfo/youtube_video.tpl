...
{def $total_count=fetch( 'contextual', 'collected_digg_info_count_list', hash( 'object_attribute_id', $node.data_map.diggs.id ) )[0]
     ...
     $userDuggStory=dugg( $node.object.id, $currentUserID )|not
}   
...
<div class="content-view-full">
    ...
    <ul class="news-digg">
      ...
      <li class="digg-it" id="diglink0" {if or( $currentUserID|eq( 10 ), $userDuggStory )|not}onClick="document.getElementById('ActionCollectInformation').click(); return false;"{/if}><a href="#">digg it</a></li>
