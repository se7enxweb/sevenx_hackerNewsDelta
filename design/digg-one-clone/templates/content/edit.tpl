...
{def $content_language = ezini( 'RegionalSettings', 'Locale' )}
    ...
    <input class="defaultbutton" type="submit" name="PublishButton" value="{'Post'|i18n( 'design/ezwebin/content/edit' )} {$class.name}" title="{'Publish the contents of the draft that is being edited. The draft will become the published version of the object.'|i18n( 'design/ezwebin/content/edit' )}" />
