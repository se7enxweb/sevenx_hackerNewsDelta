...
{* 'Digg spy (%object_count)'|i18n *}
<h1 class="context-title">{'Digg spy'|i18n( 'design/admin/infocollector/overview',, hash( '%object_count', $object_count ) )}</h1>
