...
{if $pagedesign_class.object_count|eq( 0 )|not}{set $pagedesign = $pagedesign_class.object_list[0]}{/if}{if is_set( $module_result.content_info )}{set $content_info = $module_result.content_info}{/if}
