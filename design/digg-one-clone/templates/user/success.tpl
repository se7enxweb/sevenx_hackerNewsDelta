...
<div class="feedback">
    <p>Your account was created and you are logged in so <a href="/all/(dir)/1">you can now vote for upcoming stories, comment</a> and <a href="/c#select-a-category-first">submit your first story on DiggClone</a>!</p>
</div>
{/if}
