...
<div class="form-group block">
    <label class="form-label">{'Title'|i18n( 'design/standard/class/datatype' )}</label>
    <input data-maxlength={$title_max}
        id="ezcoa-{if ne( $attribute_base, 'ContentObjectAttribute'
    )}{$attribute_base}-{/if}{$attribute.contentclassattribute_id}_{$attribute.contentclass_attribute_identifier}_title"
        ...
        type="text" name="{$attribute_base}_xrowmetadata_data_array_{$attribute.id}[title]" size="100" maxsize="255"
        value="{$attribute.content.title|wash()}" />
</div>

<div class="form-group block">
    <label class="form-label">{'Description'|i18n( 'design/standard/class/datatype' )}</label>
    <input data-maxlength="{$descr_max}"
        id="ezcoa-{if ne( $attribute_base, 'ContentObjectAttribute'
    )}{$attribute_base}-{/if}{$attribute.contentclassattribute_id}_{$attribute.contentclass_attribute_identifier}_description"
        class="form-control box ezcc-{$attribute.object.content_class.identifier} ezcca-{$attribute.object.content_class.identifier}_{$attribute.contentclass_attribute_identifier}"
        type="text" name="{$attribute_base}_xrowmetadata_data_array_{$attribute.id}[description]" size="100"
        maxsize="255" value="{$attribute.content.description|wash()}" />
</div>
