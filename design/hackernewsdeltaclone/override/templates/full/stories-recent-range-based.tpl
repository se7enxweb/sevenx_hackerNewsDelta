...
{* <div class="attribute-header">
    ...
    <div class="notice-more">
     Looking for more? Try submitting a new story to digg's <a href="{if $node.depth|lt(2)}https://{ezsys( 'hostname' )}/submit{else}https://{ezsys( 'hostname' )}/c#select-a-category-first{/if}">categories</a> section which will apear in the <a href="/all/(dir)/1">upcoming</a> section for voting to begin!
    </div>
