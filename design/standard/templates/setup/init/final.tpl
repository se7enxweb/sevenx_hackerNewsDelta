...
<p>
  {"Exponential has been installed with your select site setup. You will find the username mentioned in the details below."|i18n("design/standard/setup/init")}
</p>

<blockquote class="note">
<p>
 <b>{"Note"|i18n("design/standard/setup/init")}:</b>
 {"The first time the user or admin site is accessed it will take some time (30 to 60 seconds). This is because Exponential prepares the site for your machine."|i18n("design/standard/setup/init")}
</p>
{if $custom_text}
