...
<p>
 {"Your PHP does not have support for all databases that Exponential supports."|i18n("design/standard/setup/tests")}
 {"Although Exponential will work without it, you might later want to have support for this database prepared."|i18n("design/standard/setup/tests")}
