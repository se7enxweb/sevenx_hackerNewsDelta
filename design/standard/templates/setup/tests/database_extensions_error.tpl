...
<p>{"No supported database handlers were found. Exponential requires a database to store it's data, without one the system will fail."|i18n("design/standard/setup/tests")}</p>
<p>
