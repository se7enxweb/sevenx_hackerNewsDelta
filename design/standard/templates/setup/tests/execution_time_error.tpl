...
<h3>{$result_number}. {"Insufficient execution time allowed to install Exponential"|i18n("design/standard/setup/tests")}</h3>
<p>{"Exponential will not work correctly with a execution time limit of %1."|i18n("design/standard/setup/tests",,array($current_execution_time))}
...
<p>{"If you are running Exponential in a shared host environment, contant your ISP to perform the changes"|i18n("design/standard/setup/tests")}</p>
