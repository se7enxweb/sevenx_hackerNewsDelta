...
<p>
 {"File uploading is not enabled which means that it's impossible for Exponential to handle file uploading. All other parts of Exponential will still work fine but it's recommended to enable file uploads."|i18n("design/standard/setup/tests")}
</p>
...
<p>
 {"The PHP upload directory %upload_dir does not exists or is not accessible, without this you will not be able to upload files or images to Exponential."|i18n( 'design/standard/setup/tests',, hash( '%upload_dir', concat( '<i>', $upload_results.php_upload_dir, '</i>' ) ) )}
</p>
<p>
...
<p>
 {"The PHP upload directory %upload_dir is not writeable. This means that it will be impossible to upload files or images to Exponential."|i18n( 'design/standard/setup/tests',, hash( '%upload_dir', concat( '<i>', $upload_results.php_upload_dir, '</i>' ) ) )}
</p>
<p>
...
{section-else}
<p>
{"Exponential could not detect the user and group of the web server.
