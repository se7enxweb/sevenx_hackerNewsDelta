...
<h3>{$result_number}. {"Insufficient memory allocated to install Exponential"|i18n("design/standard/setup/tests")}</h3>
<p>{"Exponential will not work correctly with a memory limit of %1."|i18n("design/standard/setup/tests",,array($current_memory))}
