...
<p>
 {"Exponential will work with this option on however it will lead to some minor performance issues since all input variables will be made global on each script execution."|i18n("design/standard/setup/tests")}
</p>
<p>
...
<p>
{"Alternatively you may create a file called %1 in your Exponential root folder and add the following"|i18n("design/standard/setup/tests",,array("<i>.htaccess</i>"))}:
</p>
