...
<p>{"Exponential cannot write to the"|i18n("design/standard/setup/tests")} <i>settings</i> {"directory, without this the setup cannot disable itself."|i18n("design/standard/setup/tests")}</p>
