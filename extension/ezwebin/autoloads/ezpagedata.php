    ...
    function modify( $tpl, $operatorName, $operatorParameters, $rootNamespace, $currentNamespace, &$operatorValue, $namedParameters )
    {
        switch ( $operatorName )
        {
            ...
            case 'ezpagedata':
            {
                ...
                else if ( is_array( $moduleResult['path'] ) && isset( $moduleResult['path'], $moduleResult['path'][count( $moduleResult['path'] ) - 1]['node_id'] ) )
                {
                ...
                $pageDepth                = is_array( $moduleResult['path'] ) && isset( $moduleResult['path'] ) ? count( $moduleResult['path'] ) : 0;
