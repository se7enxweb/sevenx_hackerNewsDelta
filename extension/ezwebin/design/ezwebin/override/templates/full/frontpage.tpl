...
{*set-block name=view_parameters scope=global variable=$view_parameters}
{$view_parameters}
{/set-block *}
...
{/if}
    ...
    <div class="columns-frontpage float-break">
        <div class="left-column-position">
            ...
            <!-- Content: START -->
                   {attribute_view_gui attribute=$node.object.data_map.left_column view_parameters=$view_parameters}
            <!-- Content: END -->
            </div>
        </div>
