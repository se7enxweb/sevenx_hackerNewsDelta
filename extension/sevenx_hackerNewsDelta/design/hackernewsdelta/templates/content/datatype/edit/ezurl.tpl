...
<div class="form-group block">
    <label class="form-label" for="{$id_base}_url">{'URL'|i18n( 'design/standard/content/datatype' )}</label>
    <input id="{$id_base}_url"
        ...
        type="text" size="70" name="{$attribute_base}_ezurl_url_{$attribute.id}"
...
<div class="form-group block">
    ...
    <input id="{$id_base}_text"
        class="form-control box ezcc-{$attribute.object.content_class.identifier} ezcca-{$attribute.object.content_class.identifier}_{$attribute.contentclass_attribute_identifier}"
        type="text" size="70" name="{$attribute_base}_ezurl_text_{$attribute.id}"
