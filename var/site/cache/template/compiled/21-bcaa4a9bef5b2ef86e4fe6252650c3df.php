...
$oldSetArray_b2e345a2b1889e1a0f5e402aef46e1e8 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
while ( is_object( $var5 ) and method_exists( $var5, 'templateValue' ) )
    $var5 = $var5->templateValue();
$var4 = htmlspecialchars( (string) $var5 );
unset( $var5 );
if (! isset( $var4 ) ) $var4 = NULL;
while ( is_object( $var4 ) and method_exists( $var4, 'templateValue' ) )
    $var4 = $var4->templateValue();
...
$var = strtr( 'The requested view %view could not be found in module %module', $var3 );
...
<ul>
    <li>The view name was misspelled, try changing the URL.</li>
    <li>';
unset( $var );
unset( $var2 );
unset( $var3 );
...
$var = strtr( 'The view does not exist for the module %module.', $var3 );
unset( $var2, $var3, $var4, $var5 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$setArray = $oldSetArray_b2e345a2b1889e1a0f5e402aef46e1e8;
$tpl->Level--;
?>
