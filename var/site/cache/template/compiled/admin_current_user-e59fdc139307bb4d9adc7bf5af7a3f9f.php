...
$oldSetArray_9d7197525862b53ceae77f1479822ad7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '><img src="/design/admin3/images/current-user.gif" height="22" width="22" alt="" style="text-align: left; vertical-align: middle;" /></a>&nbsp;<a style="font-weight: normal; text-decoration: none; color: #000000" href=';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'current_user_link', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['current_user_link'] : null;
if (! isset( $var ) ) $var = NULL;
...
{
$text .= '        <p><img src="/design/admin3/images/current-user-disabled.gif" height="22" width="22" alt="" style="text-align: left; vertical-align: middle;" /> ';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'current_user', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['current_user'] : null;
...
$text .= '</div></li>
    <li><div><a href="/user/password" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_9d7197525862b53ceae77f1479822ad7;
$tpl->Level--;
?>
