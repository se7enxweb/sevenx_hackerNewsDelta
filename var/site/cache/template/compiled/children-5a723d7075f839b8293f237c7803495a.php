...
$oldSetArray_8777ba03f03ffb5fbbc428a38548b5fa = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="children" method="post" action="/content/action">
...
$text .= ' title="Up one level."><img src="/design/admin3/images/up-16x16-grey.png" width="16" height="16" alt="Up one level." title="Up one level." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$text .= '
    ...
    ';
$oldRestoreIncludeArray_a832256a5c83c7bd2bfa7b0ced3a7a8e = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/children_detailed-e429013c4deed5754f5e9afc012574df.php' ) && filemtime( 'var/site/cache/template/compiled/children_detailed-e429013c4deed5754f5e9afc012574df.php' ) > filemtime( 'design/admin/templates/children_detailed.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/children_detailed-e429013c4deed5754f5e9afc012574df.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_a832256a5c83c7bd2bfa7b0ced3a7a8e;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_3cb3ad2cb2cff935899d49df6e6ae609 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/alphabetical-7fef63ace6a77e01849044ce09b3e047.php' ) && filemtime( 'var/site/cache/template/compiled/alphabetical-7fef63ace6a77e01849044ce09b3e047.php' ) > filemtime( 'design/admin/templates/navigator/alphabetical.tpl' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/site/cache/template/compiled/alphabetical-7fef63ace6a77e01849044ce09b3e047.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_3cb3ad2cb2cff935899d49df6e6ae609;
...
$setArray = $oldSetArray_8777ba03f03ffb5fbbc428a38548b5fa;
$tpl->Level--;
?>
