...
$oldSetArray_d497e87602034eb3b67a18bd89031792 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form id="clearcache" action="/layout/set/print/setup/cachetoolbar" method="post">';
...
$setArray = $oldSetArray_d497e87602034eb3b67a18bd89031792;
$tpl->Level--;
?>
