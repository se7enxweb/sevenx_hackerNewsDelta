...
$oldSetArray_a52914abeb9ecb2a3b8132ea4af48c76 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div class="element">
<h3>Clear cache:</h3>';
$oldRestoreIncludeArray_705ae9e7146976b8593f0ca059ea4bad = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/clear_cache-0a35bd3ffc8e447d52b11bd153f1e082.php' ) && filemtime( 'var/site/cache/template/compiled/clear_cache-0a35bd3ffc8e447d52b11bd153f1e082.php' ) > filemtime( 'design/standard/templates/setup/clear_cache.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/clear_cache-0a35bd3ffc8e447d52b11bd153f1e082.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_705ae9e7146976b8593f0ca059ea4bad;
...
$oldRestoreIncludeArray_247b9f94152b1947ced468154edb228c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_247b9f94152b1947ced468154edb228c;
...
$setArray = $oldSetArray_a52914abeb9ecb2a3b8132ea4af48c76;
$tpl->Level--;
?>
