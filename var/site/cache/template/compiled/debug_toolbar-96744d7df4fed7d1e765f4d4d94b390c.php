...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/clear_cache-5fcd1f072336ba7bfe79d66b1c98a58e.php' ) && filemtime( 'var/site/cache/template/compiled/clear_cache-5fcd1f072336ba7bfe79d66b1c98a58e.php' ) > filemtime( 'design/standard/templates/setup/clear_cache.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/clear_cache-5fcd1f072336ba7bfe79d66b1c98a58e.php' );
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/quick_settings-fd5a5bf68720e720d12f4798890ed7f8.php' ) && filemtime( 'var/site/cache/template/compiled/quick_settings-fd5a5bf68720e720d12f4798890ed7f8.php' ) > filemtime( 'design/standard/templates/setup/quick_settings.tpl' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/site/cache/template/compiled/quick_settings-fd5a5bf68720e720d12f4798890ed7f8.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
