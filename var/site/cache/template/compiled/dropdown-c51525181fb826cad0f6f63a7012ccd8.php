<?php
// URI:       design/clone/templates/menu/dropdown.tpl
// Filename:  design/clone/templates/menu/dropdown.tpl
// Timestamp: 1772538827 (Tue Mar 3 3:53:47 PST 2026)
$oldSetArray_272868d08d20dc979e3e27883da6e213 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'root_node', $rootNamespace ) )
{
  ...
  2 => 'design/clone/templates/menu/dropdown.tpl',
) );
...
<nav class="nav">
  <div class="nav-left">
    <ul>
      ...
      ';
$oldRestoreIncludeArray_a2e45cabdbe96758bfddac0a9da8c125 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_a2e45cabdbe96758bfddac0a9da8c125;
...
$setArray = $oldSetArray_272868d08d20dc979e3e27883da6e213;
$tpl->Level--;
?>
