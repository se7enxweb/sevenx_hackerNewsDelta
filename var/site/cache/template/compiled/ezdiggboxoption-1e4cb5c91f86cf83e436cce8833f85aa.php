...
if ( $tpl->hasVariable( 'userDuggStory', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'userDuggStory' is already defined.", array (
  0 => 
  array (
    0 => 1,
    1 => 0,
  ...
  2 => 'design/delta/templates/content/datatype/collect/ezdiggboxoption.tpl',
) );
    $tpl->setVariable( 'userDuggStory', $var, $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'userDuggStory', $var, $rootNamespace );
}

$text .= '<form method="post" action="/contextual/action" name="digg';
unset( $var );
unset( $var );
...
$if_cond2 = compiledFetchAttribute( $if_cond1, 'parent' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'parent' );
unset( $if_cond1 );
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'userDuggStory', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['userDuggStory'] : null;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
unset( $if_cond2 );
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'currentUserID', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['currentUserID'] : null;
if (! isset( $if_cond2 ) ) $if_cond2 = NULL;
while ( is_object( $if_cond2 ) and method_exists( $if_cond2, 'templateValue' ) )
    $if_cond2 = $if_cond2->templateValue();
$if_cond1 = ( ( $if_cond2 ) == ( 10 ) );
unset( $if_cond2 );
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
unset( $if_cond2 );
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'userDuggStory', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['userDuggStory'] : null;
if (! isset( $if_cond2 ) ) $if_cond2 = NULL;
while ( is_object( $if_cond2 ) and method_exists( $if_cond2, 'templateValue' ) )
    $if_cond2 = $if_cond2->templateValue();
if ( $if_cond1 )
...
if ( $if_cond )
{
$text .= 'document.getElementById(\'ActionCollectDiggInformation';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
$var1 = compiledFetchAttribute( $var, 'node_id' );
...
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
$var1 = ( '/contextual/diggcollectedinfo/' . $var3 . '/' );
unset( $var3 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
$text .= ' id="diggs0" class="article-icon circle">
...
$text .= ' class="article-icon circle">
        
        &#9959;
      </a>
    </li>
    <li>
      <a onClick="document.getElementsByName(\'ContentObjectAttribute_data_option_value_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
...
unset( $var );
$var = $var1;
$var1 = compiledFetchAttribute( $var, 'diggs' );
unset( $var );
$var = $var1;
$var1 = compiledFetchAttribute( $var, 'id' );
unset( $var );
...
$text .= '\')[1].checked = true;document.getElementById(\'ActionCollectDiggInformation';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
$var1 = compiledFetchAttribute( $var, 'node_id' );
...
$text .= '/notice" class="article-down">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
...
unset( $var2 );
$var2 = $var3;
$var3 = compiledFetchAttribute( $var2, "data_int" );
unset( $var2 );
$var2 = $var3;
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$vars[$currentNamespace]['option_id'] = $var;
unset( $var );
...
unset( $show1 );
unset( $show1 );
$show1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$show2 = compiledFetchAttribute( $show1, 'content' );
unset( $show1 );
$show1 = $show2;
$show2 = compiledFetchAttribute( $show1, 'option_list' );
unset( $show1 );
$show1 = $show2;
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Options', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Options'] : null;
...
unset( $if_cond2 );
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'option_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['option_id'] : null;
if (! isset( $if_cond2 ) ) $if_cond2 = NULL;
while ( is_object( $if_cond2 ) and method_exists( $if_cond2, 'templateValue' ) )
    $if_cond2 = $if_cond2->templateValue();
...
$text .= '            <select name="ContentObjectAttribute_data_option_value_';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute'] : null;
$var1 = compiledFetchAttribute( $var, 'id' );
...
$text .= '          ';
unset( $vars[$currentNamespace]['option_id'] );
$text .= '        </div>
...
if ( $if_cond )
{
$text .= '          <input class="button" type="submit" id="ActionCollectDiggInformation';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
$var1 = compiledFetchAttribute( $var, 'node_id' );
...
$text .= '"
            name="ActionCollectDiggInformation" value="Digg it" />
