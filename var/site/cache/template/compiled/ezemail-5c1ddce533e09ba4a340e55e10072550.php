...
// Filename:  design/standard/templates/content/datatype/collect/ezemail.tpl
// Timestamp: 1768752118 (Sun Jan 18 8:01:58 PST 2026)
$oldSetArray_c4c414944c915feffd21cd0a649cecec = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '<input class="box" type="text" size="20" name="';
unset( $var );
unset( $var );
...
$setArray = $oldSetArray_c4c414944c915feffd21cd0a649cecec;
$tpl->Level--;
?>
