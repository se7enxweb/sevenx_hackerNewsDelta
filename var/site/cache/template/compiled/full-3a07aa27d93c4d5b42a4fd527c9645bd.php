...
$oldSetArray_cdeed407edd33c6a40c9a6f486da7011 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
';
$oldRestoreIncludeArray_6c9a5bbdbb7c0d5cc388714931bf43f4 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/infocollection_validation-072fdf8be59d79cfbe9df0fcd2308238.php' ) && filemtime( 'var/site/cache/template/compiled/infocollection_validation-072fdf8be59d79cfbe9df0fcd2308238.php' ) > filemtime( 'design/admin/templates/infocollection_validation.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/infocollection_validation-072fdf8be59d79cfbe9df0fcd2308238.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_6c9a5bbdbb7c0d5cc388714931bf43f4;
...
$if_cond = call_user_func_array( array( new eZRSSFunctionCollection(), 'hasExportByNode' ),
  array_values( array(     'node_id' => $if_cond1 ) ) );
...
';
$oldRestoreIncludeArray_2b1549b84344ba7b0494749fc2eb1ac7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/window_controls-931f7b6f48a8b7f6dcf6092de259e48d.php' ) && filemtime( 'var/site/cache/template/compiled/window_controls-931f7b6f48a8b7f6dcf6092de259e48d.php' ) > filemtime( 'design/admin3/templates/window_controls.tpl' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin3/templates/window_controls.tpl' );
include( '' . 'var/site/cache/template/compiled/window_controls-931f7b6f48a8b7f6dcf6092de259e48d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'design/admin3/templates/window_controls.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_2b1549b84344ba7b0494749fc2eb1ac7;
...
// foreach begins
$skipDelimiter = true;
$fe_array_d3fb2e88b20594142ca8b204cd5aeab6_1 = [];
$fe_array_keys_d3fb2e88b20594142ca8b204cd5aeab6_1 = [];
$fe_n_items_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_n_items_processed_d3fb2e88b20594142ca8b204cd5aeab6_1  = 0;
$fe_i_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_key_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_val_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_offset_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_max_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_reverse_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_first_val_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
$fe_last_val_d3fb2e88b20594142ca8b204cd5aeab6_1 = 0;
if ( !isset( $fe_variable_stack_d3fb2e88b20594142ca8b204cd5aeab6_1 ) ) $fe_variable_stack_d3fb2e88b20594142ca8b204cd5aeab6_1 = [];
...
$fe_array_keys_d3fb2e88b20594142ca8b204cd5aeab6_1 = is_array( $fe_array_d3fb2e88b20594142ca8b204cd5aeab6_1 ) ? array_keys( $fe_array_d3fb2e88b20594142ca8b204cd5aeab6_1 ) : [];
...
{
$text .= '    ';
$oldRestoreIncludeArray_6b1ba14f71d5738e168726d1fd3149bd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/children-5a723d7075f839b8293f237c7803495a.php' ) && filemtime( 'var/site/cache/template/compiled/children-5a723d7075f839b8293f237c7803495a.php' ) > filemtime( 'design/admin/templates/children.tpl' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/site/cache/template/compiled/children-5a723d7075f839b8293f237c7803495a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_6b1ba14f71d5738e168726d1fd3149bd;

}
else
{
$text .= '    ';
$oldRestoreIncludeArray_6acc7516c22ba0590550969e1f914693 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/no_children-7bbb4e0354c5407f12b5ed5c5a50bdfd.php' ) && filemtime( 'var/site/cache/template/compiled/no_children-7bbb4e0354c5407f12b5ed5c5a50bdfd.php' ) > filemtime( 'design/admin/templates/no_children.tpl' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/site/cache/template/compiled/no_children-7bbb4e0354c5407f12b5ed5c5a50bdfd.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_6acc7516c22ba0590550969e1f914693;
...
$setArray = $oldSetArray_cdeed407edd33c6a40c9a6f486da7011;
$tpl->Level--;
?>
