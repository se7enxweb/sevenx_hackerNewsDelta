<?php
// URI:       design/clone/templates/page_footer.tpl
// Filename:  design/clone/templates/page_footer.tpl
// Timestamp: 1772538982 (Tue Mar 3 3:56:22 PST 2026)
$oldSetArray_902a3ad73aea29170a71ecdb12ed6dd7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'startyear', $rootNamespace ) )
{
  ...
  2 => 'design/clone/templates/page_footer.tpl',
) );
...
<footer class="footer-main">
  <div class="footer-top">
    <div class="container">
      <nav class="nav">
        <ul>
          <li><a href="https://hackernewsdelta.com/lists">Lists</a></li>
          <li><a href="https://hackernewsdelta.com/about">About</a></li>
          <li><a href="https://hackernewsdelta.com/about/faq/guidelines">Guidlines</a></li>
          <li><a href="https://hackernewsdelta.com/about/faq">FAQ</a></li>
          <li><a href="https://hackernewsdelta.com/about/faq/security">Security</a></li>
          <li><a href="https://hackernewsdelta.com/about/faq/api">API</a></li>
          <li><a href="https://hackernewsdelta.com/about/legal">Legal</a></li>
          <li><a href="https://hackernewsdelta.com/tools">Tools</a></li>
          
          <li><a href="https://hackernewsdelta.com/about/contact">Contact</a></li>
        </ul>
      </nav>
      <form method="post" action="https://hackernewsdelta.com/content/search" class="search-box">
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="poweredby-text">
        <div>
          <a href="https://hackernewsdelta.com/" class="brand-logo">
            Hacker News <span class="text-accent">Delta</span>
          </a>
          is Powered by
          <a href="https://hackernewsdelta.com/ezinfo/about" title="Exponential CMS Open Source Web Content Management" class="link">
            Exponential
          </a>
        </div>
        <div class="attribute-image-powered-by">
          <a href="https://exponential.earth">
            <img src="/design/clone/images/content/logos/powered-by-logo-exponential.png" width="339" height="106"
...
$setArray = $oldSetArray_902a3ad73aea29170a71ecdb12ed6dd7;
$tpl->Level--;
?>
