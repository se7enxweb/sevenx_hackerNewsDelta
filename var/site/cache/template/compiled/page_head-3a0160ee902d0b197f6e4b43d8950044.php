<?php
// URI:       design/clone/templates/page_head.tpl
// Filename:  design/clone/templates/page_head.tpl
// Timestamp: 1768736688 (Sun Jan 18 3:44:48 PST 2026)
$oldSetArray_7c6c729fb7081b9a53b3f9159cf47c4e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
// def $desc
if ( $tpl->hasVariable( 'desc', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'desc' is already defined.", array (
  0 => 
  array (
    0 => 5,
    1 => 0,
  ...
  2 => 'design/clone/templates/page_head.tpl',
) );
    $tpl->setVariable( 'desc', 'Hacker News Delta is the open source social news and social bookmarking website.', $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'desc', 'Hacker News Delta is the open source social news and social bookmarking website.', $rootNamespace );
}
...
$if_cond3 = compiledFetchAttribute( $if_cond2, 'text' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
if (! isset( $if_cond2 ) ) $if_cond2 = NULL;
while ( is_object( $if_cond2 ) and method_exists( $if_cond2, 'templateValue' ) )
    $if_cond2 = $if_cond2->templateValue();
$if_cond1 = ( ( $if_cond2 ) != ( 'Home' ) );
unset( $if_cond2 );
...
unset( $if_cond3 );
unset( $if_cond3 );
$if_cond3 = ( array_key_exists( $currentNamespace, $vars ) and array_key_exists( 'item', $vars[$currentNamespace] ) ) ? $vars[$currentNamespace]['item'] : null;
$if_cond4 = compiledFetchAttribute( $if_cond3, 'text' );
unset( $if_cond3 );
$if_cond3 = $if_cond4;
if (! isset( $if_cond3 ) ) $if_cond3 = NULL;
while ( is_object( $if_cond3 ) and method_exists( $if_cond3, 'templateValue' ) )
    $if_cond3 = $if_cond3->templateValue();
$if_cond2 = ( ( $if_cond3 ) != ( 'Websites' ) );
unset( $if_cond3 );
if (! isset( $if_cond2 ) ) $if_cond2 = NULL;
while ( is_object( $if_cond2 ) and method_exists( $if_cond2, 'templateValue' ) )
    $if_cond2 = $if_cond2->templateValue();
...
if ( $namespace == '' )
    ...
    $namespace .= ':Path';
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $namespace, $vars ) and array_key_exists( 'reverse_path', $vars[$namespace] ) ) ? $vars[$namespace]['reverse_path'] : null;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
$if_cond = ( ( $if_cond1 ) != ( array (
) ) );
unset( $if_cond1 );
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
...
$if_cond2 = compiledFetchAttribute( $if_cond1, 'text' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
$if_cond = ( ( $if_cond1 ) != ( 'Home' ) );
unset( $if_cond1 );
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( $tpl->hasVariable( 'meta', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'meta' is already defined.", array (
  0 => 
  array (
    0 => 23,
    1 => 0,
  ...
  2 => 'design/clone/templates/page_head.tpl',
    ...
    $tpl->setVariable( 'meta', $var, $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'meta', $var, $rootNamespace );
}

// if begins
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'meta', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['meta'] : null;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'meta', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['meta'] : null;
$if_cond1 = compiledFetchAttribute( $if_cond, 'title' );
unset( $if_cond );
$if_cond = $if_cond1;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'meta', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['meta'] : null;
$var2 = compiledFetchAttribute( $var1, 'title' );
unset( $var1 );
$var1 = $var2;
if (! isset( $var1 ) ) $var1 = NULL;
...
unset( $var2 );
unset( $var2 );
$var2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'meta', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['meta'] : null;
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'desc', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['desc'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $var );
$var = $var1;
$var1 = compiledFetchAttribute( $var, 'original_uri' );
unset( $var );
$var = $var1;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
...
$text .= '/design/clone/images/favicon/favicon-banner.png" />
    <meta property="og:site_name" content="Hacker News Delta Open Source Project - The social news and networking website for tech professionals" />
...
$text .= '<meta name="MSSmartTagsPreventParsing" content="TRUE" />
...
$oldRestoreIncludeArray_daac881134a014b9a7147aa6e061ba3f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/link-2c86c70a58d814cae825ed7cdbd8bb24.php' ) && filemtime( 'var/site/cache/template/compiled/link-2c86c70a58d814cae825ed7cdbd8bb24.php' ) > filemtime( 'extension/sevenx_diggclone/design/digg/templates/link.tpl' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'extension/sevenx_diggclone/design/digg/templates/link.tpl' );
include( '' . 'var/site/cache/template/compiled/link-2c86c70a58d814cae825ed7cdbd8bb24.php' );
...
$tpl->processURI( 'extension/sevenx_diggclone/design/digg/templates/link.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
...
$restoreIncludeArray = $oldRestoreIncludeArray_daac881134a014b9a7147aa6e061ba3f;
...
$setArray = $oldSetArray_7c6c729fb7081b9a53b3f9159cf47c4e;
$tpl->Level--;
?>
