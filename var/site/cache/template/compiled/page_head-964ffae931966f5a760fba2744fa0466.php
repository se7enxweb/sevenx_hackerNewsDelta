...
$oldSetArray_fc8ca242f36ad287cef833e262f3db7c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'desc', $rootNamespace ) )
{
  ...
  2 => 'design/delta/templates/page_head.tpl',
) );
    $tpl->setVariable( 'desc', 'Hacker News Delta is a social news and social bookmarking website.', $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'desc', 'Hacker News Delta is a social news and social bookmarking website.', $rootNamespace );
}
...
$text .= '/design/delta/images/favicon/favicon-banner.png" />
    <meta property="og:site_name" content="Hacker News - The social news and networking website for tech professionals" />
...
$oldRestoreIncludeArray_57bbd248990d8035b3d7ec52755b06fa = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/link-57faa2bf7fc53234acbf6279330d3b93.php' ) && filemtime( 'var/site/cache/template/compiled/link-57faa2bf7fc53234acbf6279330d3b93.php' ) > filemtime( 'extension/sevenx_diggclone/design/digg/templates/link.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/link-57faa2bf7fc53234acbf6279330d3b93.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_57bbd248990d8035b3d7ec52755b06fa;
...
$setArray = $oldSetArray_fc8ca242f36ad287cef833e262f3db7c;
$tpl->Level--;
?>
