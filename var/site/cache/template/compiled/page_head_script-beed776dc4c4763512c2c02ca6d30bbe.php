<?php
// URI:       design/admin3/templates/page_head_script.tpl
// Filename:  design/admin3/templates/page_head_script.tpl
// Timestamp: 1768752117 (Sun Jan 18 8:01:57 PST 2026)
$oldSetArray_4ee3ff29fe1bcb8cc617e461549fbc18 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'load_javascript_list', $rootNamespace ) )
{
  ...
  2 => 'design/admin3/templates/page_head_script.tpl',
) );
...
$setArray = $oldSetArray_4ee3ff29fe1bcb8cc617e461549fbc18;
$tpl->Level--;
?>
