...
$oldSetArray_4506dd0247316a3a0194e7a2b0363bae = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
  ';
$oldRestoreIncludeArray_298b9074ce6708f07e0e71f8e0b4068e = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/page_head_style_inline-827aa3bba57a169cface3faef0322b0b.php' ) && filemtime( 'var/site/cache/template/compiled/page_head_style_inline-827aa3bba57a169cface3faef0322b0b.php' ) > filemtime( 'design/admin/templates/page_head_style_inline.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/page_head_style_inline-827aa3bba57a169cface3faef0322b0b.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_298b9074ce6708f07e0e71f8e0b4068e;
...
$setArray = $oldSetArray_4506dd0247316a3a0194e7a2b0363bae;
$tpl->Level--;
?>
