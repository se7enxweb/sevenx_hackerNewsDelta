<?php
// URI:       design/admin3/templates/page_head_style.tpl
// Filename:  design/admin3/templates/page_head_style.tpl
// Timestamp: 1768752117 (Sun Jan 18 8:01:57 PST 2026)
$oldSetArray_9fc7fafa26a913bd085218f73af73496 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'load_css_file_list', $rootNamespace ) )
{
  ...
  2 => 'design/admin3/templates/page_head_style.tpl',
) );
...
$text .= '
  ';
$oldRestoreIncludeArray_caad6f5f916cde49c64a957d7423df40 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/page_head_style_inline-c86eacf162020976932ab72d7daf01af.php' ) && filemtime( 'var/site/cache/template/compiled/page_head_style_inline-c86eacf162020976932ab72d7daf01af.php' ) > filemtime( 'design/admin/templates/page_head_style_inline.tpl' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/page_head_style_inline-c86eacf162020976932ab72d7daf01af.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_caad6f5f916cde49c64a957d7423df40;
...
$setArray = $oldSetArray_9fc7fafa26a913bd085218f73af73496;
$tpl->Level--;
?>
