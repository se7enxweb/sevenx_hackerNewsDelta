<?php
// URI:       design/admin3/templates/page_topmenuitem.tpl
// Filename:  design/admin3/templates/page_topmenuitem.tpl
// Timestamp: 1768752117 (Sun Jan 18 8:01:57 PST 2026)
$oldSetArray_bf338d192c5e9085691b463453634c16 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'liclass', $rootNamespace ) )
{
  ...
  2 => 'design/admin3/templates/page_topmenuitem.tpl',
) );
...
{
$text .= '            <a href=\'#\' class="disabled" title="';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'menu_item', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['menu_item'] : null;
$var1 = compiledFetchAttribute( $var, 'tooltip' );
...
$setArray = $oldSetArray_bf338d192c5e9085691b463453634c16;
$tpl->Level--;
?>
