...
$oldSetArray_09ab8282a0cdd77cdbdbe5ab5899dd34 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/content/translation">
...
<tr>
    <th class="tight"><img src="/design/admin3/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Language</th>
    <th>Locale</th>
...
$var = call_user_func_array( array( new eZContentFunctionCollection(), 'checkAccess' ),
  array_values( array(     'access' => "edit",
    'contentobject' => $var1,
...
$setArray = $oldSetArray_09ab8282a0cdd77cdbdbe5ab5899dd34;
$tpl->Level--;
?>
