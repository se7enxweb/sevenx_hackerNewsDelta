...
// Filename:  design/delta/override/templates/full/user_diggs.tpl
// Timestamp: 1768846846 (Mon Jan 19 10:20:46 PST 2026)
$oldSetArray_978eeb3d212be2ba02d02cc12d28f605 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$nod_978eeb3d212be2ba02d02cc12d28f605 = $object->attribute( 'data_map' );
else
$nod_978eeb3d212be2ba02d02cc12d28f605 = false;
unset( $node, $object );
...
if ( $tpl->hasVariable( 'childNodes', $rootNamespace ) )
{
  ...
  2 => 'design/delta/override/templates/full/user_diggs.tpl',
) );
...
if ( $if_cond )
{
$text .= '        <div class="attribute-profile-image">
            ';
$textElements = array();
...
unset( $if_cond1 );
unset( $if_cond2 );
$if_cond2 = $nod_978eeb3d212be2ba02d02cc12d28f605;
if ( !$if_cond2 )
{
unset( $if_cond2 );
...
$if_cond3 = compiledFetchAttribute( $if_cond2, 'description' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
...
if ( !isset( $if_cond2['description'] ) )
{
    $tpl->error( 'eZTemplateCompiler', "PHP variable \$if_cond2['description'] does not exist, cannot fetch the value." );
    $if_cond2 = null;
}
else
    $if_cond2 = $if_cond2['description'];
...
// def $stories
if ( $tpl->hasVariable( 'stories', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'stories' is already defined.", array (
  0 => 
  array (
    0 => 70,
    1 => 8,
  ...
  2 => 'design/delta/override/templates/full/user_diggs.tpl',
    ...
    $tpl->setVariable( 'stories', 'false', $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'stories', 'false', $rootNamespace );
}
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( $tpl->hasVariable( 'userID', $rootNamespace ) )
{
    $tpl->warning( 'def', "Variable 'userID' is already defined.", array (
  0 => 
  array (
    0 => 70,
    1 => 8,
  ...
  2 => 'design/delta/override/templates/full/user_diggs.tpl',
    ...
    $tpl->setVariable( 'userID', $var, $rootNamespace );
}
else
{
    $tpl->setLocalVariable( 'userID', $var, $rootNamespace );
}
...
// foreach begins
$skipDelimiter = true;
$fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 = [];
$fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_1 = [];
$fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_1  = 0;
$fe_i_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_key_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_val_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
if ( !isset( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_1 ) ) $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_1 = [];
$fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_1[] = @compact( 'fe_array_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_i_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_key_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_val_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_max_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_1', 'fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1' );
unset( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 );
unset( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 );
$fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'children', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['children'] : null;
if (! isset( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 ) ) $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 = NULL;
while ( is_object( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 ) and method_exists( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1, 'templateValue' ) )
    $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1->templateValue();

$fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_1 = is_array( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 ) ? array_keys( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1 ) : [];
$fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 = count( $fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_1 );
$fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 = 0;
$fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 - $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1;
$fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1 = false;
if ( $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 < 0 || $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 >= $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 )
{
    $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 = ( $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 < 0 ) ? 0 : $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1;
    if ( $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 || $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 < 0 )
 {
        eZDebug::writeWarning("Invalid 'offset' parameter specified: '$fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1'. Array count: $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1");   
}
}
if ( $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 < 0 || $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 + $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 > $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 )
{
    if ( $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 < 0 )
 eZDebug::writeWarning("Invalid 'max' parameter specified: $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1");
    $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 - $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1;
}
if ( $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1 )
{
    $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 - 1 - $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1;
    $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1  = 0;
}
else
{
    $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1;
    $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1  = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 - 1;
}
// foreach
for ( $fe_i_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_1; $fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_1 < $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 && ( $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1 ? $fe_i_bb38246fb015d0a48a9bb485e56b45fe_1 >= $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1 : $fe_i_bb38246fb015d0a48a9bb485e56b45fe_1 <= $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1 ); $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1 ? $fe_i_bb38246fb015d0a48a9bb485e56b45fe_1-- : $fe_i_bb38246fb015d0a48a9bb485e56b45fe_1++ )
{
$fe_key_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_1[$fe_i_bb38246fb015d0a48a9bb485e56b45fe_1];
$fe_val_bb38246fb015d0a48a9bb485e56b45fe_1 = $fe_array_bb38246fb015d0a48a9bb485e56b45fe_1[$fe_key_bb38246fb015d0a48a9bb485e56b45fe_1];
$vars[$rootNamespace]['child'] = $fe_val_bb38246fb015d0a48a9bb485e56b45fe_1;
$vars[$rootNamespace]['index'] = $fe_key_bb38246fb015d0a48a9bb485e56b45fe_1;
$text .= '     
     ';
unset( $var );
if (! isset( $var ) ) $var = NULL;
...
unset( $var2 );
unset( $var2 );
$var2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'childNodes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['childNodes'] : null;
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
    $var2 = $var2->templateValue();
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
...
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
if ( array_key_exists( $currentNamespace, $vars ) && array_key_exists( 'childNodes', $vars[$currentNamespace] ) )
{
    $vars[$currentNamespace]['childNodes'] = $var;
    unset( $var );
}
$text .= '     ';
// if begins
...
$text .= '    ';
$fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_1++;
} // foreach
$skipDelimiter = false;
if ( count( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_1 ) ) extract( array_pop( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_1 ) );
...
unset( $fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_i_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_key_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_val_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_max_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_1 );

unset( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_1 );
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'childNodes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['childNodes'] : null;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
    $if_cond = $if_cond->templateValue();
...
if ( $if_cond )
{
$text .= '    <div class="" style="padding-top: 0.72rem;">
    <h2><a href=';
unset( $var );
unset( $var1 );
unset( $var1 );
...
// foreach begins
$skipDelimiter = true;
$fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 = [];
$fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_2 = [];
$fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_2  = 0;
$fe_i_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_key_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_val_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
if ( !isset( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_2 ) ) $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_2 = [];
$fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_2[] = @compact( 'fe_array_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_i_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_key_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_val_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_max_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_2', 'fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2' );
unset( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 );
unset( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 );
$fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'childNodes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['childNodes'] : null;
if (! isset( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 ) ) $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 = NULL;
while ( is_object( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 ) and method_exists( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2, 'templateValue' ) )
    $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2->templateValue();

$fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_2 = is_array( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 ) ? array_keys( $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2 ) : [];
$fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 = count( $fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_2 );
$fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 = 0;
$fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 - $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2;
$fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2 = false;
if ( $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 < 0 || $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 >= $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 )
{
    $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 = ( $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 < 0 ) ? 0 : $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2;
    if ( $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 || $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 < 0 )
 {
        eZDebug::writeWarning("Invalid 'offset' parameter specified: '$fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2'. Array count: $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2");   
}
}
if ( $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 < 0 || $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 + $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 > $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 )
{
    if ( $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 < 0 )
 eZDebug::writeWarning("Invalid 'max' parameter specified: $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2");
    $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 - $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2;
}
if ( $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2 )
{
    $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 - 1 - $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2;
    $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2  = 0;
}
else
{
    $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2;
    $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2  = $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 - 1;
}
// foreach
for ( $fe_i_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_2; $fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_2 < $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 && ( $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2 ? $fe_i_bb38246fb015d0a48a9bb485e56b45fe_2 >= $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2 : $fe_i_bb38246fb015d0a48a9bb485e56b45fe_2 <= $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2 ); $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2 ? $fe_i_bb38246fb015d0a48a9bb485e56b45fe_2-- : $fe_i_bb38246fb015d0a48a9bb485e56b45fe_2++ )
{
$fe_key_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_2[$fe_i_bb38246fb015d0a48a9bb485e56b45fe_2];
$fe_val_bb38246fb015d0a48a9bb485e56b45fe_2 = $fe_array_bb38246fb015d0a48a9bb485e56b45fe_2[$fe_key_bb38246fb015d0a48a9bb485e56b45fe_2];
$vars[$rootNamespace]['child'] = $fe_val_bb38246fb015d0a48a9bb485e56b45fe_2;
$vars[$rootNamespace]['index'] = $fe_key_bb38246fb015d0a48a9bb485e56b45fe_2;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
$text .= '            ';
$fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_2++;
} // foreach
$skipDelimiter = false;
if ( count( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_2 ) ) extract( array_pop( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_2 ) );
...
unset( $fe_array_keys_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_n_items_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_n_items_processed_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_i_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_key_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_val_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_offset_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_max_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_reverse_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_first_val_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_last_val_bb38246fb015d0a48a9bb485e56b45fe_2 );

unset( $fe_variable_stack_bb38246fb015d0a48a9bb485e56b45fe_2 );
...
$text .= '    </div>    
            ...
            ';
$oldRestoreIncludeArray_c728e25f7924903200015a92bd79ac8f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'childNodes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['childNodes'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
$varData = array( 'value' => $var );
...
$restoreIncludeArray = $oldRestoreIncludeArray_c728e25f7924903200015a92bd79ac8f;
...
$setArray = $oldSetArray_978eeb3d212be2ba02d02cc12d28f605;
$tpl->Level--;
?>
